...
import { NTL_SUSPICIONS_DETAIL_QUERY } from '../graphql/NtlSuspicionDetailQueries';

export const NTL_SUSP_DETAIL_GQL: GqlTableConfig = {
  rootPath: '$.diosSet.items[*]',
  query: NTL_SUSPICIONS_DETAIL_QUERY,
  jsonPathMapping: [
    {
      key: 'detail',
      type: 'object',
