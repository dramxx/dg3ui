...
export const readREGOverviewReport: ReportConfig = {
  id: 'readREGOverviewReport',
  techDescription: 'readout IEM REG overview',
  title: 'odečtenost IEM REG',
  keywords: ['kpi chart', 'readout', 'count'],
  canvasSettings: { rows: 24, columns: 24 },
  version: '1.0.0',
  widgets: [
    {
      id: 'readout1Dwait6hours',
      type: 'KpiChart',
      overviewModule: 'READ',
      overviewId: '',
      ...
      query: `
        ...
        `,
      transformation: '{data: {id: "1Dwait6hours", value: .diosSet.avgValue}}',
      position: {
        x: 0,
        y: 0,
        height: 3,
    ...
    },
    {
      ...
      query: `
        ...
        `,
      transformation: '{data: {id: "1Dwait1day", value: .diosSet.avgValue}}',
      position: {
        x: 4,
        y: 0,
        height: 3,
    ...
    },
    {
      ...
      query: `
        ...
        `,
      transformation: '{data: {id: "1Dwait3days", value: .diosSet.avgValue}}',
      position: {
        x: 8,
        y: 0,
        height: 3,
    ...
    },
    {
      ...
      query: `
        ...
        `,
      transformation: '{data: {id: "1Dwait1week", value: .diosSet.avgValue}}',
      position: {
        x: 12,
        y: 0,
        height: 3,
    ...
    },
    {
      ...
      chartProps: {
        ...
        title: 'průběh odečtenosti IEM REG po 6 hodinách',
        legendShow: false,
    ...
    },
    {
      ...
      chartProps: {
        ...
        title: 'průběh odečtenosti IEM REG po 1 dni',
        legendShow: false,
        enableLegendHiding: true,
        enableDataSelection: true,
        enableDataLabels: false,
    ...
    },
    {
      ...
      chartProps: {
        ...
        title: 'průběh odečtenosti IEM REG po 3 dnech',
        legendShow: false,
        enableLegendHiding: true,
        enableDataSelection: true,
        enableDataLabels: false,
    ...
    },
    {
      ...
      chartProps: {
        ...
        title: 'průběh odečtenosti IEM REG po týdnu',
        legendShow: false,
        enableLegendHiding: true,
        enableDataSelection: true,
        enableDataLabels: false,
    ...
    },
    {
      ...
      chartProps: {
        ...
        title: 'Průměrná odečtenost IEM REG',
        legendShow: true,
        legendSize: 50,
        enableLegendHiding: true,
